 ...
 *
 * Movable Head Vector unitary test.
...
#define StructSize sizeof(MHVector)
#define VectorPaddingScale 2
...
int main() {
	...
	v = MHVECTOR_create(kVectorCapacity_01);
	assert(NULL != v);
	...
	MHVector* v_02 = MHVECTOR_create(kVectorCapacity_02);
	assert(NULL != v_02);
	...
	MHVector* v_03 = MHVECTOR_create(kVectorCapacity_03);
	assert(NULL != v_03);
